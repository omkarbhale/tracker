	...
	function Ie(e) {
		let t = (function (e) {
			...
			r = (function (e) {
				...
				r("first", ["&:first-child"]),
					...
					t.functional("aria", (e, t) => {
						...
						"arbitrary" === t.value.kind
							? (e.nodes = [
									w(`&[aria-${Me(t.value.value)}]`, e.nodes),
							  ])
							: (e.nodes = [
									w(
			...
			s = {
				...
				getClassOrder(e) {
					return (function (e, t) {
						let { astNodes: r, nodeSorting: n } = Pe(
								Array.from(t),
								e
							),
			...
			let r = 5;
			{
				...
				n &&
					...
					e.theme.add(
						...
						et(t.fontFamily.sans, "fontFeatureSettings") ??
							"normal",
						r
					),
					e.theme.add(
						"--default-font-variation-settings",
						et(t.fontFamily.sans, "fontVariationSettings") ??
							"normal",
						r
					));
			}
			{
				...
				n &&
					...
					e.theme.add(
						...
						et(t.fontFamily.mono, "fontFeatureSettings") ??
							"normal",
						r
					),
					e.theme.add(
						"--default-mono-font-variation-settings",
						et(t.fontFamily.mono, "fontVariationSettings") ??
							"normal",
						r
					));
			}
				...
				lr.start(`Build #${t} (${e})`),
					"full" === e &&
						(await (async function () {
							lr.start("Create compiler"),
								lr.start("Reading Stylesheets");
